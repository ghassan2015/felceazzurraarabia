...
//        $products=Product::get();
    ...
    public function store(Request $request)
    {
        ...
        try{
            $product=new Product();
            $product->name=['ar'=>$request->title_ar,'en'=>$request->title_en];
            $product->slug=['ar'=>$this->slug($request->title_ar),'en'=>$this->slug($request->title_en)];

            $product->smell_product=['ar'=>$request->smell_product_ar,'en'=>$request->smell_product_en];
            $product->fragrance=['ar'=>$request->description_ar,'en'=>$request->description_en];
            $product->formula=['ar'=>$request->formula_ar,'en'=>$request->formula_en];
            $product->size=['ar'=>$request->size_ar,'en'=>$request->size_en];
