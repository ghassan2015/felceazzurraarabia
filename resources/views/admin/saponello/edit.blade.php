	...
	<div class="col-12 col-lg-12 p-0 ">
		...
		<div class="col-12 col-lg-12 p-0 main-box">
			...
			<div class="col-12 col-lg-6 p-2">
                ...
                <div class="col-12 col-lg-6 p-2">
                    <div class="col-12">العنوان  باللغة الانجليزية
                    </div>
                    <div class="col-12 pt-3">
                        <input type="text" name="title_en" required   maxlength="190" class="form-control" value="{{$saponello->getTranslation('title','en')}}" >
                    </div>
                </div>
                ...
                <div class="col-12 col-lg-6 p-2">
                    ...
                    <div class="col-12 pt-3">
                        <input type="text" name="sub_title_en" required   maxlength="190" class="form-control" value="{{$saponello->getTranslation('sub_title','en')}}" >
                    </div>
                </div>
			...
			<div class="col-12 col-lg-6 p-2">
                ...
                <div class="col-12 col-lg-6 p-2">
                    ...
                    <div class="col-12 pt-3">
                        <textarea name="description_en" class="description_editor" >{{$saponello->getTranslation('description','en')}}</textarea>
                    </div>
                </div>
