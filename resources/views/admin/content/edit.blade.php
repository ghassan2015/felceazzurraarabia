                ...
                <div class="col-12 col-lg-12 p-0 main-box">
                    ...
                    <div class="col-12 p-3 row">
                        ...
                        <div class="col-12 col-lg-6 p-2">
                            ...
                            <div class="col-12 pt-3">
                                <input type="text" name="title_en" required   maxlength="190" class="form-control" value="{{$content->getTranslation('title','en')}}" >
                            </div>
                        </div>
                        ...
                        <div class="col-12 col-lg-6 p-2">
                            ...
                            <div class="col-12 pt-3">
                                <input type="text" name="sub_title_en" required   maxlength="190" class="form-control" value="{{$content->getTranslation('sub_title','en')}}" >
                            </div>
                        </div>
