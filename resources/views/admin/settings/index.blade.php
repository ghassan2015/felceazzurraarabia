	 	...
	 	<div class="col-12 col-lg-8 px-3 py-5">
	 		...
	 		<div class="col-12 row p-0 taber active" id="general-tab">
                ...
                اسم الموقع باللغة الانجليزية
                    ...
                    <div class="col-6 col-lg-9 px-2">
                        <input type="" name="website_name_en" class="form-control" value="{{$settings->getTranslation('website_name','en')}}"  maxlength="190">
                    </div>
                ...
                <div class="col-12 px-0 d-flex mb-3 row pb-3">
                    ...
                    <div class="col-12 col-lg-9 px-2">
                        <textarea name="address_en" class="form-control">{{$settings->getTranslation('address','en')}}</textarea>
                    </div>
                </div>
		 		<div class="col-12 px-0 d-flex mb-3 row pb-3">
		 			<div class="col-12 col-lg-3 px-2 text-lg-end pt-1 pb-3 pb-lg-0">
...
عن الموقع باللغة العربية		 			</div>
                ...
                <div class="col-12 px-0 d-flex mb-3 row pb-3">
                    <div class="col-12 col-lg-3 px-2 text-lg-end pt-1 pb-3 pb-lg-0">
                        عن الموقع باللغة الانجليزية                    </div>
                    <div class="col-12 col-lg-9 px-2">
                        <textarea name="website_bio_en" class="form-control">{{$settings->getTranslation('website_bio','en')}}</textarea>
                    </div>
                </div>
