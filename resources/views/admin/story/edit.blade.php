            ...
            <form class="needs-validation "  name="edit_story"   action="{{route('admin.story.update')}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-12 col-lg-6 p-2">
                            ...
                            <input type="text" name="title_en" required class="form-control" id="title_en"
                                   placeholder="@lang('admin.title_en')"  value="{{$story->getTranslation('title','en')}}">
                            <div class="invalid-feedback">
                                العنوان باللغة الانجليزية
                            </div>
                        </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-12 col-lg-6 p-2">
                            ...
                            <div class="editor  col-12 pt-3">
                                <textarea class="form-control  kt-tinymce-2" required name="description_en">{!! $story->getTranslation('description','en') !!}</textarea>
                            </div>
