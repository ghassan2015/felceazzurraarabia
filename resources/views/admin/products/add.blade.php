                ...
                <div class="card card-custom example example-compact">
                    ...
                    <div class="card-body">
                        ...
                        <div class="col-12 col-lg-6 p-2">
                            ...
                            <div class="col-12 pt-3">
                                <input type="text" name="title_en"    maxlength="190" class="form-control" value="{{old('title_en')}}" >
                            </div>
                        </div>
                        ...
                        <div class="col-12 col-lg-6 p-2">
                            ...
                            <div class="col-12 pt-3">
                                <input type="text" name="smell_product_en"    maxlength="190" class="form-control" value="{{old('smell_product_en')}}" ></div>
                        </div>
                        ...
                        <div class="col-12 col-lg-6 p-2">
                            ...
                            <div class="col-12 pt-3">
                                <textarea class="description_editor"   id="description_en"  name="description_en">{!!  old('description_en')!!}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="col-12 col-lg-6 p-2">
                            ...
                            <div class="col-12 pt-3">
                                <textarea class="description_editor" id="formula_en"  name="formula_en">{!!  old('formula_en')!!}</textarea>
                            </div>
                        </div>
...
صورة تركيبة المنتج
                        ...
                        <div class="col-6 col-lg-6 p-2">
                            ...
                            <div class="col-12 pt-3">
                                <textarea name="meta_description_en" class="form-control"  style="min-height:150px">{{old('meta_description_en')}}</textarea>
                            </div>
                        </div>
                        <div class="col-12 col-lg-6 p-2">
                            <div class="col-12">
...
حجم العبوة باللغة الانجليزية
                            ...
                            <div class="col-12 pt-3">
                                <input type="text" name="size_en"    maxlength="190" class="form-control" value="{{old('size_en')}}" >
                            </div>
                        </div>
