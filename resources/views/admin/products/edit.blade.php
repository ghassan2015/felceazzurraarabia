                ...
                <div class="col-12 col-lg-12 p-0 main-box">
                    <div class="card card-custom example example-compact">
                        ...
                        <div class="col-12 col-lg-6 p-2">
                            ...
                            <div class="col-12 pt-3">
                                <input type="text" name="title_en"    maxlength="190" class="form-control" value="{{$product->getTranslation('name','en')}}" >
                            </div>
                        </div>
                        ...
                        <div class="col-12 col-lg-6 p-2">
                            ...
                            <div class="col-12 pt-3">
                                <textarea class="description_editor" name="description_en">{!! $product->getTranslation('fragrance','en')!!}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="col-12 col-lg-6 p-2">
                            ...
                            <div class="col-12 pt-3">
                                <textarea class="description_editor"  name="formula_en">{!! $product->getTranslation('formula','en')!!}</textarea>
                            </div>
                        </div>
...
<img src="{{asset('assets/images/products/'.$product->product_image)}}" width="200px" height="200px">
                        ...
                        <div class="col-6 col-lg-6 p-2">
                            ...
                            <div class="col-12 pt-3">
                                <textarea name="meta_description_en" class="form-control"  style="min-height:150px">{{$product->getTranslation('meta_description','en')}}</textarea>
                            </div>
                        </div>
                        <div class="col-12 col-lg-6 p-2">
                            <div class="col-12">
